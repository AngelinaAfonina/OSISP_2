...
LRESULT CALLBACK MyWindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		DrawTxt(hDC, 0, 4, "Angelina");
		DrawTxt(hDC, 1, 1, "Angelina");
		DrawTxt(hDC, 4, 1, "Afonina");
		DrawTxt(hDC, 4, 2, "Never look back");
		DrawTxt(hDC, 3, 4, "Better a new friend than an old foe");
		EndPaint(hWnd, &ps);
		break;
	}
